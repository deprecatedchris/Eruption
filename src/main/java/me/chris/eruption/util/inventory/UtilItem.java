package me.chris.eruption.util.inventory;
...
public class UtilItem
{
    ...
    public static ItemStack createItem(final Material m, final int amount, final short durability, final String name, Enchantment enchantment, int level) {
        ItemStack itemStack = new ItemStack(m, amount, durability);
        if (name != null) {
            itemStack = name(itemStack, name);
        }
