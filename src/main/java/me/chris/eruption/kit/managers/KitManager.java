...
public class KitManager {
	...
	private void loadKits() {
		...
		kitSection.getKeys(false).forEach(name -> {
			String displayName = kitSection.getString(name + ".displayName") == null ? "&c" + name
			...
			Kit kit = new Kit(name, displayName, contents, armor, kitEditContents, icon, icon, excludedArenas, arenaWhiteList, enabled, ranked, q, kitFlag);
